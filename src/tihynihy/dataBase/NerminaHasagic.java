...
import java.awt.event.ActionListener;
    ...
    public class NerminaHasagic extends JFrame implements ActionListener {
        ...
        public NerminaHasagic(){
            ...
            JTextField nameField = new JTextField(" Name: Nermina Hasagić");
            nameField.setBounds(350,70,200,30);
            nameField.setEditable(false);



            JTextField ageField = new JTextField("Age : 45");
            ageField.setBounds(350,110,200,30);
            ageField.setEditable(false);



            JTextField placeField = new JTextField("Doboj");
            ...
            JTextField idField = new JTextField(" ID: 399765122");
            ...
            JTextField birthField = new JTextField(" Date of birth: 05.11.1984");
            ...
            ImageIcon avatar = new ImageIcon("patientImage/nerminaHasagicImage.png");
