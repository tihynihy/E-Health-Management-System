...
import java.awt.event.ActionListener;
    ...
    public class DinoKermelic extends JFrame implements ActionListener {
        ...
        public DinoKermelic(){
            ...
            JTextField nameField = new JTextField(" Name: Dino Kermelić");
            nameField.setBounds(350,70,200,30);
            nameField.setEditable(false);



            JTextField ageField = new JTextField("Age : 22");
            ageField.setBounds(350,110,200,30);
            ageField.setEditable(false);



            JTextField placeField = new JTextField("Sarajevo , Novi Grad");
            ...
            JTextField idField = new JTextField(" ID: 100987231");
            ...
            JTextField birthField = new JTextField(" Date of birth: 06.10.1975");
            ...
            ImageIcon avatar = new ImageIcon("patientImage/dinoKermelicImage.png");
