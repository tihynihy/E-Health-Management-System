package tihynihy.dataBase;

import tihynihy.mainFrame;
...
import java.awt.event.ActionListener;
    ...
    public class ElvedinMahtumic extends JFrame implements ActionListener {
        ...
        public ElvedinMahtumic(){
            ...
            JTextField nameField = new JTextField(" Name: Elvedin Mahtumić");
            nameField.setBounds(350,70,200,30);
            nameField.setEditable(false);



            JTextField ageField = new JTextField("Age : 35");
            ageField.setBounds(350,110,200,30);
            ageField.setEditable(false);



            JTextField placeField = new JTextField("Ilijaš");
            ...
            JTextField genderField = new JTextField(" Gender: Male");
            ...
            JTextField idField = new JTextField(" ID: 200200200");
            ...
            JTextField birthField = new JTextField(" Date of birth: 09.01.1990");
            ...
            ImageIcon avatar = new ImageIcon("patientImage/elvedinMahtumicImage.png");
